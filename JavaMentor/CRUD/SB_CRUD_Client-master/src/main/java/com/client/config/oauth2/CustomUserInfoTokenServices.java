package com.client.config.oauth2;
...
public class CustomUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public OAuth2Authentication loadAuthentication(String accessToken) throws AuthenticationException, InvalidTokenException {
        ...
        if (map.containsKey("sub")) {
            String googleName = (String) map.get("email");
            User user = userService.getByName(googleName);
            if (user == null) {
                user = new User();
    ...
    private OAuth2Authentication extractAuthentication(Map<String, Object> map) {
        ...
        List<GrantedAuthority> authorities = AuthorityUtils.createAuthorityList(Role.ROLE_ADMIN.toString());
